...
return array(
    ...
    "First name" => "Prénom",
    "Last name" => "Nom",
    "Export to CSV" => "Exporter en format CSV",
    "New password" => "Nouveau mot de passe",
    "New password (again)" => "Confirmation du mot de passe",
    "Password successfully changed." => "Votre mot de passe à été changé avec succès.",
    "Comment" => "Commentaire",
    "Upload an avatar" => "Télécharger un avatar",
    "Fill out your account" => "Compléter les informations de votre compte utilisateur",
    "Update your account" => "Modifiez votre compte",
    "Your account has been updated" => "Votre compte à été mis à jour",
    "Fill out your information" => "Complétez ou modifiez vos informations",
    "Email confirmation sent to %s" => "Un e-mail a été envoyé à l'adresse %s",
    "You have to download a image file with .jpg or .png format" => "Vous devez télécharger un fichier image au format .jpg ou .png",
    "Email address" => "Adresse e-mail",
    "Your account" => "Votre compte",
    "You do not have permission" => "Vous n'avez pas la permission d'effectuer cette action",
    "Your information" => "Vos informations",
    "Remove current file" => "Supprimer le fichier courant",
    "Website" => "Site web",
    "Send" => "Envoyer",
    "'%value%'is already taken, please choose another." => "'%value%' est déjà pris, veuillez en choisir un autre.",
    "Translate" => "Translate",
    "Special characters are not allowed" => "Les caractères spéciaux ne sont pas autorisés",
    "Undefined" => "Undefined",
    "Show all" => "Show all",
    "Show only digest" => "Show only digest",
    "Following flux" => "Following flux",
    "Register" => "Register",
    ...
    "Tasks" => "Tasks",
    "Dashboard" => "Dashboard",
    "Are you sure? This operation can not be undone" => "Êtes-vous sûr ? Cette opération ne peut pas être annulée",
    "Edit properties" => "Editer ses propriétés",
    "Delete" => "Supprimer",
    "Save" => "Save",
    "isEmpty" => "Cette valeur ne peut pas être vide",
    ...
    "Cancel" => "Annuler",
    "Label" => "Libellé",
    "Your message has been sent" => "Votre message à été envoyé",
    "Users" => "Utilisateurs",
    "User" => "Utilisateur",
    "Log out" => "Déconnexion",
    "Is valid?" => "Validé ?",
    "View website" => "Voir le site",
    "Owner first name" => "Prénom du détenteur",
    "Owner username" => "Nom d'utilisateur du détenteur",
    "Owner last name" => "Nom du détenteur",
    "Is active?" => "Est actif ?",
