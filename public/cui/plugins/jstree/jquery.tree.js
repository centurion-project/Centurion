...
(function ($) {
	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				'.jstree ul, .jstree li { display:block; padding:0 0 0 0; list-style-type:none; } ' + ''; 
//				'.jstree li { display:block; min-height:21px; line-height:21px; white-space:nowrap; min-width:21px; } ' + 
//				'.jstree-rtl li { margin-left:0; margin-right:18px; } ' + 
//				'.jstree > ul > li { margin-left:0px; } ' + 
//				'.jstree-rtl > ul > li { margin-right:0px; } ' + 
//				'.jstree ins { display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; } ' + 
//				'.jstree a { display:inline-block; line-height:2px; height:21px; color:black; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; } ' + 
...
//				'.jstree-rtl li a ins { margin-right:0px; margin-left:3px; } ';
		...
		if(/msie/.test(u) && parseInt(v, 10) == 7) { 
			is_ie7 = true;
			css_string += '.jstree li a { border-width:0 !important; padding:4px !important; } ';
		}
