...
class Cms_Form_Model_Flatpage extends Centurion_Form_Model_Abstract //implements Translation_Traits_Form_Model_Interface
{
    public function __construct($options = array(), Centurion_Db_Table_Row_Abstract $instance = null)
    {
        ...
        $this->_exclude = array('created_at', 'id', 'updated_at', 'mptt_lft', 'mptt_rgt',
                                'slug', 'mptt_level', 'mptt_tree_id', 'faltpage_type', 'cover_id', 'mptt_parent_id', 'flatpage_position_id');
        ...
        $this->_elementLabels = array(
            ...
            'flatpage_position_id'      => $this->_translate('Position'),
    ...
    public function init()
    {
        ...
        //$this->getElement('flatpage_position_id')->setAttrib('large', true);

        //$this->getElement('mptt_parent_id')->setAttrib('large', true);

        $this->getElement('published_at')->setAttrib('large', true);
        $this->getElement('published_at')->setRequired(false)->setAttrib('class', 'field-datepicker');;
    ...
    public function setInstance(Centurion_Db_Table_Row_Abstract $instance = null)
    {
        ...
        if ($instance !== null) {
            ...
            if (null !== $this->getElement('published_at') && $instance !== null) {
                ...
                $to = Zend_Locale_Data::getContent(null, 'date', array('gregorian', 'short'));
    ...
    public function saveInstance($values = null)
    {
        ...
        $from = Zend_Locale_Data::getContent(null, 'date', array('gregorian', 'short'));
