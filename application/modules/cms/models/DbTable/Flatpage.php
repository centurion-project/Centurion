...
class Cms_Model_DbTable_Flatpage extends Centurion_Db_Table_Abstract implements /*Translation_Traits_Model_DbTable_Interface,*/ Core_Traits_Mptt_Model_DbTable_Interface
{
    ...
    protected $_referenceMap = array(
        'flatpage_position' => array(
                'columns' => 'flatpage_position_id',
                'refColumns' => 'id',
                'refTableClass' => 'Cms_Model_DbTable_FlatpagePosition',
...
//        ),
    ...
    public function getFlatpagesByPosition($position, $maxDepth = null, $limit = null, $order = null, $select = null)
    {
        if (null === $select) {
            $select = $this->select(true);
        }

        $select->wherePosition($position)
               ->wherePublished(true);

        if (null !== $maxDepth) {
            $select = $this->getLimitDepthSelect($maxDepth, $select);
        }
