...
class Centurion_Controller_AGL extends Centurion_Controller_Action
{
     ...
     *          'sort'  => 'col'|array('callback function to sort'),
     *          'type'  => 'COLS_ROW_COL',
     *          'column'=> 'my_column',
     *          'filters' => array(
    ...
    {
        $isoFormat = Zend_Locale_Data::getContent(Zend_Registry::get('Zend_Locale'), 'date', array('gregorian', 'short'));
    ...
    public function getFilter()
    {
        if (null === $this->_filter) {
            $this->_filter = new Admin_Form_Filter(array('filters' => $this->_filters));
