...
//        $this->_request->setParams($this->getHelper('params')->direct());
        ...
        $this->_rowActions = array('Edit'   => array('url'           => array(array('id' => '___id___', 'action' => 'get')),
                                                     'cls'           => 'ui-icon-pencil',
                                                    ),
                                   'Delete' => array('url'           => array(array('id' => '___id___', 'action' => 'delete')),
                                                     'cls'           => 'ui-icon-close',
    ...
    {
        Centurion_Traits_Common::checkTraitOverload($this, '_preRenderForm', array());
    }
...
//        }
        ...
        foreach ($this->_getParam('rowId') as $id) {
