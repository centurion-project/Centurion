...
class Centurion_Controller_Mptt extends Centurion_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->getHelper('ContextAutoSwitch')->direct(array('create', 'delete'));
    ...
    public function deleteAction()
    {
        ...
        if (!$this->getRequest()->isXmlHttpRequest()) {
            return $this->getHelper('redirector')->gotoSimple('index', $this->getRequest()->getControllerName(), $this->getRequest()->getModuleName(), $this->_request->getParams());
        } else {
    ...
    protected function _processValues($url = null)
    {
        if ($this->getRequest()->isPost()) {
            ...
            if ($this->_getForm()->isValid($values)) {
                ...
                if (!$this->getRequest()->isXmlHttpRequest()) {
                    return $this->getHelper('redirector')->gotoUrl($url);
                }
            } else {
