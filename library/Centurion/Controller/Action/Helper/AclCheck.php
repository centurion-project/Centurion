        ...
        if (!$aclResult) {
            ...
            if (null !== $url) {
            	if (PHPUNIT == true) {
            		...
            		$this->getActionController()->getHelper('redirector')->gotoUrl($url);
            		throw new Exception('die');
            	} else {
	                return $this->getActionController()->getHelper('redirector')->gotoUrlAndExit($url);
	            }
            } else {
                $params = array();
                ...
                if (PHPUNIT == true) {
                	...
                	return $this->getActionController()->getHelper('redirector')
