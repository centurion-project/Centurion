...
class Centurion_Db_Table_Select extends Zend_Db_Table_Select implements Centurion_Traits_Traitsable
{
    ...
    public function addDependentTable($rule, $localTable = null, $cols = null, $joinType = self::JOIN_TYPE_INNER)
    {
        ...
        // Caster les variables en tableau, utile quand une seule colonne est pr�cis� dans la referenceMap
        $refMap['refColumns'] = (array) $refMap['refColumns'];
        $refMap['columns'] = (array) $refMap['columns'];

        // Cr�ation de la condition de jointure pour la referenceMap
        $joinCond = array();
        ...
        /* Dans le cas o� il y a plusieurs colonnes dans la referenceMap, cr�er une string avec toutes les conditions
         * du tableau $joinCond
         */
        $joinCond = implode(' AND ', $joinCond);
