 ...
 */
class Translation_Test_Traits_Form_Model_FirstModel
        extends     Centurion_Form_Model_Abstract
        implements  Translation_Traits_Form_Model_Interface {


    public function __construct($options = array()) {
        $this->_model = new Translation_Test_Traits_Model_DbTable_FirstModel();
        ...
        $this->_elementLabels = array(
            ...
            'second1_id'   	        =>  $this->_translate('Description@backoffice'),
            'second2_id' 	        =>  $this->_translate('Miniature@backoffice'),
    ...
    public function init()   {
        ...
        $this->addReferenceSubForm(new Translation_Test_Traits_Form_Model_SecondModel(), 'second1');
        $this->addReferenceSubForm(new Translation_Test_Traits_Form_Model_SecondModel(), 'second2');
    }
