...
class Translation_Test_Traits_Model_DbTable_Row_LocalizedTest
    ...
    /**
     * Check behavior of an localized row to get a translatable dependent rowset
     */
    public function testMethodGetTranslatedDependentRowFromLocalizedRow(){
        $this->_switchLocale('en');
        ...
        $this->assertInstanceOf(
            ...
            $fourths,
            'Error, the translated dependent rowset from the localized row is not an '
        ...
        $this->assertInstanceOf(
            ...
            $fourths->getTable(),
            'Error, the translated dependent rowset from the localized row was not retrieved from the good model'
        );
        ...
        $this->assertCount(
            1,
            $fourths,
            'Error, the translated dependent rowset from the localized row must contain only two elements'
        );
        ...
        $this->assertEquals(
            2,
            $firstDependent->id,
            'Error, the translated dependent row from the localized row is not the expected row (must has the id : 2)'
        );
    }
     ...
     */
    public function testMethodGetNonTranslatableDependentRowFromLocalizedRow(){
        $this->_switchLocale('en');
        ...
        $this->assertInstanceOf(
            'Centurion_Db_Table_Rowset_Abstract',
            $thirds,
            'Error, the non-translatable dependent rowset from the localized row is not an '
                .'instance of Centurion_Db_Table_Rowset_Abstract'
        );
        ...
        $this->assertInstanceOf(
            ...
            $thirds->getTable(),
            'Error, the non-translatable dependent rowset from the localized row was '
        ...
        $this->assertEquals(
            2,
            $thirds->count(),
            'Error, the non-translatable dependent rowset from the localized row must contain only two elements'
        );
    ...
    public function testPreSaveBehaviorForInsertWithDuplicationFromLocalizedRow(){
        ...
        $secondModel = new Translation_Test_Traits_Model_DbTable_SecondModel();
    ...
    public function testPreSaveBehaviorForInsertWithSetNullFromLocalizedRow(){
        ...
        $thirdModel = new Translation_Test_Traits_Model_DbTable_ThirdModel();
