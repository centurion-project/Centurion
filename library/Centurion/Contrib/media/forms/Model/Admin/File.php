...
class Media_Form_Model_Admin_File extends Media_Form_Model_File
{
    ...
    public function init()
    {
        ...
        $this->_filename->getPluginLoader(Zend_Form_Element_File::TRANSFER_ADAPTER)->addPrefixPath(
            'Centurion_File_Transfer_Adapter', 'Centurion/File/Transfer/Adapter/'
        );
        ...
        $this->_filename->setDestination($options['uploads_dir'])->addValidator('Count', false, 1)->addValidator(
            'Size', false, 4194304
        ) //4*1024*1024
