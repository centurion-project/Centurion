...
//$1 'Zend/Search/Lucene/Search/QueryToken.php';



/** Zend_Search_Lucene_FSM */
//$1 'Zend/Search/Lucene/FSM.php';
...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public function __construct()
    {
        ...
        //$1 'Zend/Search/Lucene/Search/QueryLexer.php';
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        //$1 'Zend/Search/Lucene/Search/QueryParserException.php';
        try {
            //$1 'Zend/Search/Lucene/Search/QueryParserContext.php';
    ...
    {
        //$1 'Zend/Search/Lucene/Search/QueryEntry/Term.php';
    ...
    {
        //$1 'Zend/Search/Lucene/Search/QueryEntry/Phrase.php';
    ...
    public function subqueryEnd()
    {
        ...
        //$1 'Zend/Search/Lucene/Search/QueryEntry/Subquery.php';
