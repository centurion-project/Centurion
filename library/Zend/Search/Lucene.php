...
//$1 'Zend/Search/Lucene/Document/Html.php';

/** Zend_Search_Lucene_Document_Docx */
//$1 'Zend/Search/Lucene/Document/Docx.php';

/** Zend_Search_Lucene_Document_Pptx */
//$1 'Zend/Search/Lucene/Document/Pptx.php';

/** Zend_Search_Lucene_Document_Xlsx */
//$1 'Zend/Search/Lucene/Document/Xlsx.php';

/** Zend_Search_Lucene_Search_QueryParser */
//$1 'Zend/Search/Lucene/Search/QueryParser.php';

/** Zend_Search_Lucene_Search_QueryHit */
//$1 'Zend/Search/Lucene/Search/QueryHit.php';
...
//$1 'Zend/Search/Lucene/Search/Query/Phrase.php';

/** Zend_Search_Lucene_Search_Query_MultiTerm */
//$1 'Zend/Search/Lucene/Search/Query/MultiTerm.php';

/** Zend_Search_Lucene_Search_Query_Wildcard */
//$1 'Zend/Search/Lucene/Search/Query/Wildcard.php';

/** Zend_Search_Lucene_Search_Query_Range */
//$1 'Zend/Search/Lucene/Search/Query/Range.php';

/** Zend_Search_Lucene_Search_Query_Fuzzy */
//$1 'Zend/Search/Lucene/Search/Query/Fuzzy.php';
...
//$1 'Zend/Search/Lucene/Search/Query/Insignificant.php';
...
//$1 'Zend/Search/Lucene/Interface.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
//$1 'Zend/Search/Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_LockManager */
//$1 'Zend/Search/Lucene/LockManager.php';
...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
    ...
    public static function create($directory)
    {
        ...
        //$1 'Zend/Search/Lucene/Proxy.php';
    ...
    public function __construct($directory = null, $create = false)
    {
        ...
        if (is_string($directory)) {
            //$1 'Zend/Search/Lucene/Storage/Directory/Filesystem.php';
        ...
        if ($create) {
            ...
            //$1 'Zend/Search/Lucene/Index/Writer.php';
    ...
    public function getSimilarity()
    {
        ...
        //$1 'Zend/Search/Lucene/Search/Similarity.php';
    ...
    public function terms()
    {
        ...
        //$1 'Zend/Search/Lucene/Index/TermsPriorityQueue.php';
    ...
    public function resetTermsStream()
    {
        if ($this->_termsStream === null) {
            ...
            //$1 'Zend/Search/Lucene/TermStreamsPriorityQueue.php';
