...
/** Zend_Pdf_Style */
//$1 'Zend/Pdf/Style.php';

/** Zend_Pdf_Color_GrayScale */
//$1 'Zend/Pdf/Color/GrayScale.php';

/** Zend_Pdf_Color_Rgb */
//$1 'Zend/Pdf/Color/Rgb.php';

/** Zend_Pdf_Color_Cmyk */
//$1 'Zend/Pdf/Color/Cmyk.php';

/** Zend_Pdf_Color_Html */
//$1 'Zend/Pdf/Color/Html.php';

/** Zend_Pdf_Image */
//$1 'Zend/Pdf/Image.php';
...
//$1 'Zend/Pdf/Element/String/Binary.php';
//$1 'Zend/Pdf/Element/Boolean.php';
//$1 'Zend/Pdf/Element/Dictionary.php';
//$1 'Zend/Pdf/Element/Name.php';
//$1 'Zend/Pdf/Element/Null.php';
//$1 'Zend/Pdf/Element/Numeric.php';
//$1 'Zend/Pdf/Element/String.php';
  ...
  /**** Class Constants ****/
    ...
    public function __construct($source = null, $revision = null, $load = false)
    {
        ...
        if ($source !== null) {
            ...
            //$1 'Zend/Pdf/Trailer/Generator.php';
    ...
    protected function _dumpPages()
    {
        ...
        // Refresh outlines
        //$1 'Zend/Pdf/RecursivelyIteratableObjectsContainer.php';
    ...
    public function extractFonts()
    {
        ...
        foreach ($fontResourcesUnique as $resourceId => $fontDictionary) {
            try {
                // Try to extract font
                //$1 'Zend/Pdf/Resource/Font/Extracted.php';
