...
//$1 'Zend/Memory/Manager.php';

/** Zend_Memory_Value */
//$1 'Zend/Memory/Value.php';

/** Zend_Memory_Container */
//$1 'Zend/Memory/Container.php';
...
class Zend_Memory
{
    ...
    public static function factory($backend, $backendOptions = array())
    {
        ...
        //$1 str_replace('_', DIRECTORY_SEPARATOR, $backendClass) . '.php';
