 ...
 */
//$1 'Zend/Gdata/Gapps/UserFeed.php';

/**
 * @see Zend_Gdata_Gapps_NicknameFeed
 */
//$1 'Zend/Gdata/Gapps/NicknameFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListFeed
 */
//$1 'Zend/Gdata/Gapps/EmailListFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListRecipientFeed
 */
//$1 'Zend/Gdata/Gapps/EmailListRecipientFeed.php';
...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    public static function throwServiceExceptionIfDetected($e) {
        ...
        if (!$response) {
          //$1('Zend/Gdata/App/IOException.php');
        ...
        try {
            ...
            //$1 'Zend/Gdata/Gapps/ServiceException.php';
