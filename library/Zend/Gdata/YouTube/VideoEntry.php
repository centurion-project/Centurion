 ...
 */
//$1 'Zend/Gdata/YouTube/MediaEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_MediaGroup
 */
//$1 'Zend/Gdata/YouTube/Extension/MediaGroup.php';

/**
 * @see Zend_Gdata_YouTube_Extension_NoEmbed
 */
//$1 'Zend/Gdata/YouTube/Extension/NoEmbed.php';
 ...
 */
//$1 'Zend/Gdata/YouTube/Extension/Link.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Racy
 */
//$1 'Zend/Gdata/YouTube/Extension/Racy.php';
 ...
 */
//$1 'Zend/Gdata/YouTube/Extension/Control.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Recorded
 */
//$1 'Zend/Gdata/YouTube/Extension/Recorded.php';
...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry
{
    ...
    public function setVideoRating($ratingValue)
    {
        if ($ratingValue < 1 || $ratingValue > 5) {
            //$1 'Zend/Gdata/App/InvalidArgumentException.php';
