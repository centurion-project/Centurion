 ...
 */
//$1 'Zend/CodeGenerator/Php/Abstract.php';

/**
 * @see Zend_CodeGenerator_Php_Member_Container
 */
//$1 'Zend/CodeGenerator/Php/Member/Container.php';

/**
 * @see Zend_CodeGenerator_Php_Method
 */
//$1 'Zend/CodeGenerator/Php/Method.php';

/**
 * @see Zend_CodeGenerator_Php_Property
 */
//$1 'Zend/CodeGenerator/Php/Property.php';

/**
 * @see Zend_CodeGenerator_Php_Docblock
 */
//$1 'Zend/CodeGenerator/Php/Docblock.php';
...
class Zend_CodeGenerator_Php_Class extends Zend_CodeGenerator_Php_Abstract
{
    ...
    public function setDocblock($docblock)
    {
        ...
        if (is_array($docblock)) {
            ...
            //$1 'Zend/CodeGenerator/Php/Exception.php';
