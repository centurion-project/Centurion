...
class Zend_Crypt_Math_BigInteger
{
    ...
    public function __construct($extension = null)
    {
        if (!is_null($extension) && !in_array($extension, array('bcmath', 'gmp', 'bigint'))) {
            //$1('Zend/Crypt/Math/BigInteger/Exception.php');
