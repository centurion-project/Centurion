...
//$1 'Zend/Feed/Writer/Feed.php';

/** @see Zend_Version */
//$1 'Zend/Version.php';

/** @see Zend_Feed_Writer_Renderer_RendererInterface */
//$1 'Zend/Feed/Writer/Renderer/RendererInterface.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom */
//$1 'Zend/Feed/Writer/Renderer/Entry/Atom.php';

/** @see Zend_Feed_Writer_Renderer_Entry_Atom_Deleted */
//$1 'Zend/Feed/Writer/Renderer/Entry/Atom/Deleted.php';

/** @see Zend_Feed_Writer_Renderer_RendererAbstract */
//$1 'Zend/Feed/Writer/Renderer/RendererAbstract.php';

//$1 'Zend/Feed/Writer/Renderer/Feed/Atom/AtomAbstract.php';
