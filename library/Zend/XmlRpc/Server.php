 ...
 */
//$1 'Zend/Server/Abstract.php';

/**
 * XMLRPC Request
 */
//$1 'Zend/XmlRpc/Request.php';

/**
 * XMLRPC Response
 */
//$1 'Zend/XmlRpc/Response.php';

/**
 * XMLRPC HTTP Response
 */
//$1 'Zend/XmlRpc/Response/Http.php';

/**
 * XMLRPC server fault class
 */
//$1 'Zend/XmlRpc/Server/Fault.php';

/**
 * XMLRPC server system methods class
 */
//$1 'Zend/XmlRpc/Server/System.php';

/**
 * Convert PHP to and from xmlrpc native types
 */
//$1 'Zend/XmlRpc/Value.php';
 ...
 */
//$1 'Zend/Server/Reflection/Function/Abstract.php';
 ...
 */
//$1 'Zend/Server/Reflection/Method.php';
 ...
 * Example:
 * <code>
 * //$1 'Zend/XmlRpc/Server.php';
 * //$1 'Zend/XmlRpc/Server/Cache.php';
 * //$1 'Zend/XmlRpc/Server/Fault.php';
 * //$1 'My/Exception.php';
 * //$1 'My/Fault/Observer.php';
 *
 * // Instantiate server
 ...
 *     //$1 'Some/Service/Class.php';
 *     //$1 'Another/Service/Class.php';
 *
...
class Zend_XmlRpc_Server extends Zend_Server_Abstract
{
    ...
    public function __call($method, $params)
    {
        ...
        if (!method_exists($system, $method)) {
            //$1 'Zend/XmlRpc/Server/Exception.php';
    ...
    public function handle($request = false)
    {
        ...
        if ((!$request || !$request instanceof Zend_XmlRpc_Request)
            ...
            //$1 'Zend/XmlRpc/Request/Http.php';
