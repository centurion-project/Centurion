...
class Zend_Service_Technorati
{
    ...
    public function cosmos($url, $options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/CosmosResultSet.php';
    ...
    public function search($query, $options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/SearchResultSet.php';
    ...
    public function tag($tag, $options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/TagResultSet.php';
    ...
    public function dailyCounts($query, $options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/DailyCountsResultSet.php';
    ...
    public function topTags($options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/TagsResultSet.php';
    ...
    public function blogInfo($url, $options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/BlogInfoResult.php';
    ...
    public function getInfo($username, $options = null)
    {
         ...
         */
        //$1 'Zend/Service/Technorati/GetInfoResult.php';
    ...
    public function keyInfo()
    {
         ...
         */
        //$1 'Zend/Service/Technorati/KeyInfoResult.php';
