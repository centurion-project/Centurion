 ...
 */
//$1 'Zend/Service/WindowsAzure/Credentials/SharedAccessSignature.php';
 ...
 */
//$1 'Zend/Service/WindowsAzure/Storage/BlobContainer.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_BlobInstance
 */
//$1 'Zend/Service/WindowsAzure/Storage/BlobInstance.php';

/**
 * @see Zend_Service_WindowsAzure_Storage_SignedIdentifier
 */
//$1 'Zend/Service/WindowsAzure/Storage/SignedIdentifier.php';
...
class Zend_Service_WindowsAzure_Storage_Blob extends Zend_Service_WindowsAzure_Storage
{
    ...
    public function registerStreamWrapper($name = 'azure')
    {
         ...
         */
        //$1 'Zend/Service/WindowsAzure/Storage/Blob/Stream.php';
