 ...
 */
//$1 'Zend/Service/DeveloperGarden/Client/Soap.php';

/**
 * @see Zend_Service_DeveloperGarden_Credential
 */
//$1 'Zend/Service/DeveloperGarden/Credential.php';

/**
 * @see Zend_Service_DeveloperGarden_SecurityTokenServer
 */
//$1 'Zend/Service/DeveloperGarden/SecurityTokenServer.php';
...
abstract class Zend_Service_DeveloperGarden_Client_ClientAbstract
{
    ...
    public function __construct(array $options = array())
    {
        ...
        if (empty($this->_wsdlFile)) {
            //$1 'Zend/Service/DeveloperGarden/Exception.php';
