 ...
 */
//$1 'Zend/Service/DeveloperGarden/Response/IpLocation/LocateIPResponseType.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_IpLocation_LocateIPResponse
 */
//$1 'Zend/Service/DeveloperGarden/Response/IpLocation/LocateIPResponse.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_IpLocation_IPAddressLocationType
 */
//$1 'Zend/Service/DeveloperGarden/Response/IpLocation/IPAddressLocationType.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_IpLocation_RegionType
 */
//$1 'Zend/Service/DeveloperGarden/Response/IpLocation/RegionType.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_IpLocation_GeoCoordinatesType
 */
//$1 'Zend/Service/DeveloperGarden/Response/IpLocation/GeoCoordinatesType.php';

/**
 * @see Zend_Service_DeveloperGarden_Response_IpLocation_CityType
 */
//$1 'Zend/Service/DeveloperGarden/Response/IpLocation/CityType.php';

/**
 * @see Zend_Service_DeveloperGarden_Request_IpLocation_LocateIPRequest
 */
//$1 'Zend/Service/DeveloperGarden/Request/IpLocation/LocateIPRequest.php';
