 ...
 */
//$1 "PHPUnit/Extensions/Database/Operation/IDatabaseOperation.php";
 ...
 */
//$1 "PHPUnit/Extensions/Database/Operation/Exception.php";

/**
 * @see Zend_Test_PHPUnit_Db_Connection
 */
//$1 "Zend/Test/PHPUnit/Db/Connection.php";
