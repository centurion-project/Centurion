...
//$1 'PHPUnit/Runner/Version.php';

/** @see Zend_Controller_Front */
//$1 'Zend/Controller/Front.php';

/** @see Zend_Controller_Action_HelperBroker */
//$1 'Zend/Controller/Action/HelperBroker.php';
...
abstract class Zend_Test_PHPUnit_ControllerTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        //$1 'Zend/Test/PHPUnit/Constraint/DomQuery.php';
    ...
    {
        $this->_incrementAssertionCount();
        //$1 'Zend/Test/PHPUnit/Constraint/Redirect.php';
    ...
    {
        $this->_incrementAssertionCount();
        //$1 'Zend/Test/PHPUnit/Constraint/ResponseHeader.php';
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            //$1 'Zend/Controller/Request/HttpTestCase.php';
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            //$1 'Zend/Controller/Response/HttpTestCase.php';
