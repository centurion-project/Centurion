 ...
 */
//$1 'Zend/InfoCard/Xml/EncryptedData.php';

/**
 * Zend_InfoCard_Xml_Assertion
 */
//$1 'Zend/InfoCard/Xml/Assertion.php';

/**
 * Zend_InfoCard_Cipher
 */
//$1 'Zend/InfoCard/Cipher.php';

/**
 * Zend_InfoCard_Xml_Security
 */
//$1 'Zend/InfoCard/Xml/Security.php';

/**
 * Zend_InfoCard_Adapter_Interface
 */
//$1 'Zend/InfoCard/Adapter/Interface.php';

/**
 * Zend_InfoCard_Claims
 */
//$1 'Zend/InfoCard/Claims.php';
...
class Zend_InfoCard
{
    ...
    public function getAdapter()
    {
        if($this->_adapter === null) {
            //$1 'Zend/InfoCard/Adapter/Default.php';
